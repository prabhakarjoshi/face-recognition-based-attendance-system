...
def Mark_Manuallly_Fun():
    def Mark_Manually():
        ...
        root8.destroy()
        tkinter.messagebox.showinfo("Marked","Attendance has been marked successfully for '"+entry_1.get()+"'")
    root8=Tk()
    ...
    but_add=Button(root8, text='Mark',activebackground="#2C394B",bg="#2C394B",fg="#ffffff",command=Mark_Manually).place(x=150,y=200)
    root8.mainloop()
# Mark_Manuallly_Fun()